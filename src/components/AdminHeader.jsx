                ...
                <nav className="navbar navbar-expand-lg bg-light">
                    <div className="container-fluid" style={{ justifyContent: "space-between" }}>
                        ...
                        <div id="_navbarSupportedContent" style={{justifyContent:"space-between"}}>
                            <Link to={"/notifications"} className="btn btn-sm rounded-circle p-1 px-1 mx-2 shadow shadow-sm text-blue"><i className="bi bi-bell"></i> <small className="text-danger bg-light" style={{position:"absolute",marginLeft:-8,marginTop:5}}>30</small> </Link>
